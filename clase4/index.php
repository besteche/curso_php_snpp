...
while ($temperatura <= 10) {
    $rednessClass = 'Redness-' . $temperatura;

    // Use the temperature and redness classes defined in the CSS file
    echo "<p class='temperature'>La temperatura es: <span class='$rednessClass'>$temperatura</span></p>";
